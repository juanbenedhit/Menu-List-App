...
class FrenchFriesPage extends StatefulWidget {
  const FrenchFriesPage({super.key});

  @override
  State<FrenchFriesPage> createState() => _FrenchFriesPageState();
}

// state untuk french fries, tempat dan mengelola state dari french fries
class _FrenchFriesPageState extends State<FrenchFriesPage> {
  static const String appTitle = 'Classic Crispy Fries';
      ...
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              ImageSection(image: 'images/frenchfries.jpg'),
              TitleSection(
                name: 'Classic Crispy Fries',
                shortDesc: 'Crispy, golden fries made from fresh potatoes',
              ),
              FavoriteButton(),
              TextSection(
                description:
                    'Our French Fries are hand-cut from premium, locally sourced potatoes, '
                    'double-fried to achieve the perfect crispy exterior and fluffy interior. '
                    'Lightly seasoned with sea salt and served hot, they are the perfect companion '
                    'to any meal or a satisfying snack on their own. Dip them in our signature sauces '
                    'or enjoy them plain — either way, you’ll experience a classic taste with every bite.',
              ),
            ],
          ),
        ),
